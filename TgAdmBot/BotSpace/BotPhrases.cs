...
namespace TgAdmBot.BotSpace
{
    ...
    {
        public static string[] OldMessagePh = { "Похоже это было до того как я пришла, я не понмаю о чем ты(" };
        public static string[] ReplyToMesage = { "Я не понимаю о чем ты, ответь, пожалуйста, на сообщение, которое хочешь мне показать" };
        public static string[] HelpMessage = {"О чем бы ты хотел узнать? \n" +
                                              "1. Развлечения \n" +
                                              "2. Настройка беседы\n" +
                                              "3. Администрирование",
        ...
        public static string[] NextChatRules = { "Отлично! А теперь скажи мне какие правила нужны" };
        public static string[] setRights = { "Окей, записала, теперь он " };
        public static string[] NotEnoughtRights = { "Прости, но ты не можешь делать такие громкие заявления(" };
        public static string[] ShortMessage = { "Кажется ты меня обманываешь... Как-то слишком коротко..." };
    }
}
